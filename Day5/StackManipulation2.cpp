...
void reverseStack(stack<char>* e, int elemToReverse) {
    queue<char> temp;
    for (int i=0; i<elemToReverse; i++) {
        temp.push(e->top());
        e->pop();
    }
    for (int i=0; i<elemToReverse; i++) {
...
int main () {
    ...
    if (myfile.is_open()) {
        ...
        while ( getline (myfile, line) )
        {
            ...
            reverseStack(stacks.at(to - 1), move); // removing this line gives the answer to part1
